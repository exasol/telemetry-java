...
class TelemetryConfigTest {
    // [utest~telemetry-config-defaults~1->scn~tracking-controls-overrides-configured-endpoint-via-environment-variable~1]
    @Test
    ...
    // [utest~telemetry-config-client-identity-defaults~1->scn~client-identity-attaches-configured-identity-values-to-emitted-telemetry-messages~1]
    @Test
    ...
    // [utest~telemetry-config-endpoint-override~1->scn~tracking-controls-overrides-configured-endpoint-via-environment-variable~1]
    @Test
    ...
    // [utest~telemetry-config-disabled-value-detection~1->scn~tracking-controls-disables-tracking-via-environment-variables~1]
    // [utest~telemetry-config-disabled-value-detection-in-ci~1->scn~tracking-controls-disables-tracking-automatically-in-ci~1]
    @Test
    ...
    // [utest~telemetry-config-rejects-blank-project-tag~1->scn~client-identity-requires-project-tag-and-product-version~1]
    @Test
    ...
    // [utest~telemetry-config-rejects-blank-product-version~1->scn~client-identity-requires-project-tag-and-product-version~1]
    @Test
    ...
    // [utest~telemetry-config-default-endpoint~1->scn~tracking-controls-overrides-configured-endpoint-via-environment-variable~1]
    @Test
