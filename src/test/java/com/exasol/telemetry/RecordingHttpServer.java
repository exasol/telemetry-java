...
final class RecordingHttpServer implements AutoCloseable
{
    ...
    private RecordingHttpServer(int failuresBeforeSuccess, long responseDelayMillis)
    {
        try {
    ...
    static RecordingHttpServer createDelayedSuccessServer(long responseDelayMillis)
    {
        return new RecordingHttpServer(0, responseDelayMillis);
    }

    static RecordingHttpServer createFlakyServer(int failuresBeforeSuccess)
    {
    ...
    List<RecordedRequest> awaitRequests(int expectedCount, Duration timeout) throws InterruptedException
    {
    ...
    private void handle(HttpExchange exchange) throws IOException
    {
        ...
        int status = requests.size() <= failuresBeforeSuccess ? 500 : 202;
    ...
    static final class RecordedRequest
    {
        ...
        private RecordedRequest(String method, String body, Instant receivedAt)
        {
            this.method = method;
            this.body = body;
