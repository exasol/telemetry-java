...
class HttpTransportTest {
    ...
    // [utest~http-transport-sends-json-payload~1->scn~async-delivery-sends-queued-events-asynchronously-over-http~1]
    @Test
    ...
    // [utest~http-transport-rejects-non-success~1->scn~async-delivery-sends-queued-events-asynchronously-over-http~1]
    @Test
    ...
    // [utest~http-transport-handles-interruption~1->scn~async-delivery-sends-queued-events-asynchronously-over-http~1]
    @Test
